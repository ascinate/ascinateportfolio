...
export default function Page() {
    ...
    const categories = [
        ...
        { name: "Health", filter: ".category-2" },
         { name: "Software & IT", filter: "all" },
        { name: "Farming", filter: ".category-3" },
        { name: "Real Estate", filter: ".category-2" },
         { name: "Finance", filter: "all" },
        { name: "E-Commerce", filter: ".category-3" },
