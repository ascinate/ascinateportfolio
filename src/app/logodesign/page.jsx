...
export default function Home() {
  ...
  const categories = [
    { name: "All", value: "all" },
    { name: "Travel", value: "category-3" },
    { name: "Health", value: "category-2" },
    { name: "Software & IT", value: "category-4" },
    { name: "Farming", value: "category-5" },
    { name: "Real Estate", value: "category-6" },
    { name: "Finance", value: "category-7" },
        { name: "E-commerce", value: "category-5" },
    { name: "Grooming", value: "category-6" },
    { name: "Directory", value: "category-7" },
  ];
